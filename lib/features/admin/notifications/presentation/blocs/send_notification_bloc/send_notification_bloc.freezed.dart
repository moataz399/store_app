...
class __$$SendNotificationImplCopyWithImpl<$Res>
    extends _$SendNotificationEventCopyWithImpl<$Res, _$SendNotificationImpl>
...
class _$SendNotificationImpl implements SendNotification {
  ...
  @override
  String toString() {
    return 'SendNotificationEvent.sendNotification(title: $title, body: $body, productId: $productId, indexId: $indexId)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return sendNotification(title, body, productId, indexId);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return sendNotification?.call(title, body, productId, indexId);
  }
...
abstract class SendNotification implements SendNotificationEvent {
  const factory SendNotification(
      {required final String title,
      required final String body,
      required final int productId,
      required final int indexId}) = _$SendNotificationImpl;
...
class _$LoadingImpl implements Loading {
  const _$LoadingImpl({required this.indexId});
...
abstract class Loading implements SendNotificationState {
  const factory Loading({required final int indexId}) = _$LoadingImpl;
...
abstract class Success implements SendNotificationState {
...
class __$$ErrorImplCopyWithImpl<$Res>
    extends _$SendNotificationStateCopyWithImpl<$Res, _$ErrorImpl>
...
abstract class Error implements SendNotificationState {
